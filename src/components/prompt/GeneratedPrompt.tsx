  ...
  return (
    <div className="rounded-xl border border-sw-border bg-sw-surface/80 backdrop-blur-sm">
      <div className="flex items-center justify-between border-b border-sw-border px-5 py-3">
        <h3 className="font-heading text-[10px] text-neon-pink">
          GENERATED PROMPT
        </h3>
        {hasContent && (
          <Button
      ...
      <pre className="max-h-96 overflow-auto whitespace-pre-wrap p-5 font-code text-xs leading-relaxed text-text-primary">
        {promptText}
      </pre>
    </div>
  );
